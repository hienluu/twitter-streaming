...
#$SPARK_HOME/bin/spark-submit --class "TwitterStreamingApp" --master local[*] ./target/twitter-streaming-1.0.jar $CONSUMER_KEY $CONSUMER_SECRET $ACCESS_TOKEN $ACCESS_TOKEN_SECRET
